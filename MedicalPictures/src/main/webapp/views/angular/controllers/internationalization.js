...
MedicalPictures.config(function($translateProvider) {
  $translateProvider.translations('en', {
    ...
    'NO_USERS_TO_REMOVE_SELECTED':'There are no selected users to remove!',
    'NO_PICTURES_TO_REMOVE_SELECTED':'There are no selected pictures to remove',
  ...
  $translateProvider.translations('pl', {
    ...
    'NO_PICTURES_TO_REMOVE_SELECTED':'Nie wybrano żadnych zdjęć do usunięcia!',
