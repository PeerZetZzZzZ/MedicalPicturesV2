...
public class TechnicianViewManagePictures extends HttpServlet {
    ...
    private Log logger = LogFactory.getLog(TechnicianViewManagePictures.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("GET " + TechnicianViewManagePictures.class.toString() + " :No permission to see the content!");
        } catch (NoLoggedUserExistsHere ex) {
            logger.error("GET " + TechnicianViewManagePictures.class.toString() + " : No logged user exists!");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("POST " + TechnicianViewManagePictures.class.toString() + " :No permission to see the content!");
        } catch (NoLoggedUserExistsHere ex) {
            logger.error("POST " + TechnicianViewManagePictures.class.toString() + " : No logged user exists!");
        }
    }
