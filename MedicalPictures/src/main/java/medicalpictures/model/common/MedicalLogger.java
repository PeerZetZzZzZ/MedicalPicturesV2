...
/**
 * Medical logger used to log every important event in application. Log is made in standard output ( for example Glassfish output ) and log file (log file location for glassfish:
 * glassfishInstallation/glassfish/domains/domain1/config/ ). Log file name is today's date in such form: YYYY-MM-DD.txt
 *
